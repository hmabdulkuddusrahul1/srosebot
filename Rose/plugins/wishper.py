...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@xenpaicc [@username] text`")
        description = "Usage: @xenpaicc [@username] text"
        button = InlineKeyboardButton(
            "More-Help",
            url="https://t.me/xenpaicc?start=learn"
        )
...
@xenpaicc your whisper @username
...
example:- 
@xenpaicc hello this is a test @xenpaicc
